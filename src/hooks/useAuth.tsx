...
function AuthProvider({ children }: AuthProviderData) {
  ...
  async function signIn() {
    try {
      ...
      const REDIRECT_URI = "https://auth.expo.io/@arlinmafra/streamData"
      ...
      const { type, params } = await startAsync({authUrl}) as AuthSessionResult
      ...
      throw new Error('Erro ao logar no siatema')
    } finally {
